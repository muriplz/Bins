  ...
  <div class="settings-container">
    ...
    <div class="settings-content">
      <div class="setting-item">
        ...
        <span>Pos: {{ hasGPSData ? `${coords.latitude.toFixed(2)}, ${coords.longitude.toFixed(2)}` : 'Unknown' }}</span>
      ...
      <div v-if="hasGPSData" class="location-info">
        <p><strong>GPS Status:</strong> {{ isActive ? 'Active' : 'Inactive' }}</p>
        <p><strong>Latitude:</strong> {{ coords.latitude.toFixed(7) }}</p>
        <p><strong>Longitude:</strong> {{ coords.longitude.toFixed(7) }}</p>
      </div>
    </div>
